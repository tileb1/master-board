...
extern volatile uint32_t currentImuSeqNumber;
extern volatile uint32_t currentBaroSeqNumber;
extern volatile uint32_t currentBaroTimestamp;
extern volatile uint32_t currentPitotSeqNumber;
